...
public class Prjava43garcia23 extends Frame 
   ...
   public Prjava43garcia23 () { 
      ...
      setTitle("nova finestra prjava43garcia23");
   ...
   public static void main(String[] args) { 
      new Prjava43garcia23();  // Let the construct do the job 
   } 
